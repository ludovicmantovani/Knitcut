    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                ...
                .WithCancelingThrough("<Keybord>/escape")
                .OnCancel(
                    operation =>
                    {
                        action.Enable();
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        if (CheckFuplicateBindings(action, bindingIndex, allCompositeParts))
                        {
                            action.RemoveBindingOverride(bindingIndex);
                            CleanUp();
        ...
        private bool CheckFuplicateBindings(InputAction action,int bindingIndex,bool allCompositeParts = false)
        {
